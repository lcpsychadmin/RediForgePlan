// client/src/components/objects/DataObjectTasksSection.tsx
...
interface DataObjectTasksSectionProps {
  projectId: string;
  projectObjectId: string;
}

/**
 * Section displaying tasks associated with a project object
 * Groups by task type and allows inline editing
 */
export const DataObjectTasksSection: React.FC<DataObjectTasksSectionProps> = ({
  projectId,
  projectObjectId,
}) => {
  ...
  // Group tasks by type
  const tasksByType = allTasks.reduce(
    (acc, task) => {
  ...
  if (allTasks.length === 0) {
    return (
      <Box sx={{ py: 2 }}>
        <Alert severity="info">No tasks associated with this object</Alert>
      </Box>
    );
  }
...
export default DataObjectTasksSection;
