  ...
  const createMutation = useMutation({
    ...
    onMutate: async (payload) => {
      ...
      const optimistic: Defect = {
        ...
        taskId,
        title: payload.title,
        defectDetails: payload.defectDetails || null,
        rootCauseDetails: payload.rootCauseDetails || null,
        resolutionDetails: payload.resolutionDetails || null,
        rootCauseCategoryId: payload.rootCauseCategoryId || null,
        targetResolutionDate: payload.targetResolutionDate || null,
